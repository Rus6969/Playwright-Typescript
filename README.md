...
2. **Installation**: Clone this repository and run `npm install` to install the required dependencies.

3. **Writing Tests**: Create new tests in the `tests` directory using TypeScript. Leverage the Page Object Model for better test script organization.

4. **Running Tests**: Execute your tests with `npm test`.
...
We welcome contributions from the community. Whether it's fixing bugs, adding new features, or improving documentation, your help is greatly appreciated. Please follow our [Contributing Guidelines](CONTRIBUTING.md) for more information.
